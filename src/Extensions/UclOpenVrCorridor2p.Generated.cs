...
namespace UclOpenHfVisualDataSchema
{
    ...
    [Bonsai.WorkflowElementCategoryAttribute(Bonsai.ElementCategory.Source)]
    [Bonsai.CombinatorAttribute(MethodName="Generate")]
    public partial class MouseWheelMovementSource : MovementSource
    {
    
        private double _gain;
    
        public MouseWheelMovementSource()
        {
        }
    
        protected MouseWheelMovementSource(MouseWheelMovementSource other) : 
                base(other)
        {
            _gain = other._gain;
        }
    
        [Newtonsoft.Json.JsonPropertyAttribute("gain", Required=Newtonsoft.Json.Required.Always)]
        public double Gain
        {
            get
            {
        ...
        public System.IObservable<MouseWheelMovementSource> Generate()
        {
            return System.Reactive.Linq.Observable.Defer(() => System.Reactive.Linq.Observable.Return(new MouseWheelMovementSource(this)));
        }
    
        public System.IObservable<MouseWheelMovementSource> Generate<TSource>(System.IObservable<TSource> source)
        {
            return System.Reactive.Linq.Observable.Select(source, _ => new MouseWheelMovementSource(this));
        }
    ...
    [Bonsai.WorkflowElementCategoryAttribute(Bonsai.ElementCategory.Source)]
    [Bonsai.CombinatorAttribute(MethodName="Generate")]
    public partial class PlaybackMovementSource : MovementSource
    {
        ...
        protected PlaybackMovementSource(PlaybackMovementSource other) : 
                base(other)
        {
        ...
        public System.IObservable<PlaybackMovementSource> Generate()
        {
            return System.Reactive.Linq.Observable.Defer(() => System.Reactive.Linq.Observable.Return(new PlaybackMovementSource(this)));
        }
    
        public System.IObservable<PlaybackMovementSource> Generate<TSource>(System.IObservable<TSource> source)
        {
            return System.Reactive.Linq.Observable.Select(source, _ => new PlaybackMovementSource(this));
        }
    ...
    [Bonsai.WorkflowElementCategoryAttribute(Bonsai.ElementCategory.Source)]
    [Bonsai.CombinatorAttribute(MethodName="Generate")]
    public partial class SensorMovementSource : MovementSource
    {
    
        public SensorMovementSource()
        {
        }
    
        protected SensorMovementSource(SensorMovementSource other) : 
                base(other)
        {
        }
    
        public System.IObservable<SensorMovementSource> Generate()
        {
            return System.Reactive.Linq.Observable.Defer(() => System.Reactive.Linq.Observable.Return(new SensorMovementSource(this)));
        }
    
        public System.IObservable<SensorMovementSource> Generate<TSource>(System.IObservable<TSource> source)
        {
            return System.Reactive.Linq.Observable.Select(source, _ => new SensorMovementSource(this));
        }
    ...
    public partial class Trial
    {
        ...
        public Trial()
        {
            ...
            _boundaryThreshold = -36D;
            _endTrialThreshold = -36D;
            _maximumTrialTime = 180D;
    ...
    public partial class UclOpenVrCorridor2pRig
    {
        ...
        private MovementSource _movementSource;
        ...
        protected UclOpenVrCorridor2pRig(UclOpenVrCorridor2pRig other)
        {
            ...
            _movementSource = other._movementSource;
        }
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        [Newtonsoft.Json.JsonPropertyAttribute("movementSource", Required=Newtonsoft.Json.Required.Always)]
        public MovementSource MovementSource
        {
            get
            {
                return _movementSource;
            }
            set
            {
        ...
        protected virtual bool PrintMembers(System.Text.StringBuilder stringBuilder)
        {
            ...
            stringBuilder.Append("MovementSource = " + _movementSource);
            return true;
        }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Bonsai.Sgen", "0.6.1.0 (Newtonsoft.Json v13.0.0.0)")]
    [Newtonsoft.Json.JsonConverter(typeof(JsonInheritanceConverter), "sourceType")]
    [JsonInheritanceAttribute("mouse_wheel", typeof(MouseWheelMovementSource))]
    [JsonInheritanceAttribute("playback", typeof(PlaybackMovementSource))]
    [JsonInheritanceAttribute("sensor_movement", typeof(SensorMovementSource))]
    [Bonsai.WorkflowElementCategoryAttribute(Bonsai.ElementCategory.Source)]
    [Bonsai.CombinatorAttribute(MethodName="Generate")]
    public partial class MovementSource
    {
        ...
        protected MovementSource(MovementSource other)
        {
        }
    
        public System.IObservable<MovementSource> Generate()
        {
            return System.Reactive.Linq.Observable.Defer(() => System.Reactive.Linq.Observable.Return(new MovementSource(this)));
        }
    
        public System.IObservable<MovementSource> Generate<TSource>(System.IObservable<TSource> source)
        {
            return System.Reactive.Linq.Observable.Select(source, _ => new MovementSource(this));
        }
    ...
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(Bonsai.Expressions.TypeMapping<MouseWheelMovementSource>))]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(Bonsai.Expressions.TypeMapping<PlaybackMovementSource>))]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(Bonsai.Expressions.TypeMapping<SensorMovementSource>))]
    public partial class MatchMovementSource : Bonsai.Expressions.SingleArgumentExpressionBuilder
    {
        ...
        public override System.Linq.Expressions.Expression Build(System.Collections.Generic.IEnumerable<System.Linq.Expressions.Expression> arguments)
        {
            ...
            var returnType = typeMapping != null ? typeMapping.GetType().GetGenericArguments()[0] : typeof(MovementSource);
            return System.Linq.Expressions.Expression.Call(
                typeof(MatchMovementSource),
                "Process",
        ...
        private static System.IObservable<TResult> Process<TResult>(System.IObservable<MovementSource> source)
            where TResult : MovementSource
        {
            return System.Reactive.Linq.Observable.Create<TResult>(observer =>
            {
                var sourceObserver = System.Reactive.Observer.Create<MovementSource>(
                    value =>
                    {
    ...
    public partial class SerializeToJson
    {
        ...
        public System.IObservable<string> Process(System.IObservable<MouseWheelMovementSource> source)
        {
            return Process<MouseWheelMovementSource>(source);
        }

        public System.IObservable<string> Process(System.IObservable<PlaybackMovementSource> source)
        {
            return Process<PlaybackMovementSource>(source);
        }
        ...
        public System.IObservable<string> Process(System.IObservable<SensorMovementSource> source)
        {
            return Process<SensorMovementSource>(source);
        }
        ...
        public System.IObservable<string> Process(System.IObservable<MovementSource> source)
        {
            return Process<MovementSource>(source);
        }
    }
    ...
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(Bonsai.Expressions.TypeMapping<MovementSource>))]
