...
class Trial(BaseSchema):
    ...
    boundary_threshold: float = Field(default=200, description="Buffer applied to far boundary of corridor to determine stopping distance.")
    end_trial_threshold: float = Field(default=200, description="Buffer applied to far boundary of corridor to determine trial end distance.")
